...
if result.status_.ID == "UserStatusRecently" and result.profile_photo_ ~= false then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, amir.photos_[0].sizes_[1].photo_.persistent_id_,''..rdphoto..'\n𖢄 𝐘𝐨𝐮𝐫 𝐢𝐝↬ '..msg.sender_user_id_..'\n𖢄 𝐔𝐬𝐞𝐫 𝐍𝐞𝐦𝐞↬ '..username..'\n𖢄 𝐑𝐮𝐭𝐛𝐚↬ '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n𖢄 𝐒𝐭𝐚𝐬𝐭↬ '..rtpa..'\n𖢄 𝐑𝐞𝐚𝐜𝐭𝐢𝐨𝐧↬'..Total_Msg(Msguser)..'\n𖢄 𝐌𝐬𝐠𝐬↬ '..Msguser..'\n𖢄 𝐁𝐢𝐨↬ '..getbioY..' \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉┉ ≈ ┉ ≈ ┉\n')
else 
if result.status_.ID == "UserStatusEmpty" and result.profile_photo_ == false then
send(msg.chat_id_, msg.id_,'[\n𖢄 𝐘𝐨𝐮𝐫 𝐢𝐝↬ '..msg.sender_user_id_..'\n𖢄 𝐔𝐬𝐞𝐫 𝐍𝐞𝐦𝐞↬ '..username..'\n𖢄 𝐑𝐮𝐭𝐛𝐚↬ '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n𖢄 𝐒𝐭𝐚𝐬𝐭↬ '..rtpa..'\n𖢄 𝐑𝐞𝐚𝐜𝐭𝐢𝐨𝐧↬'..Total_Msg(Msguser)..'\n𖢄 𝐌𝐬𝐠𝐬↬ '..Msguser..'\n𖢄 𝐁𝐢𝐨↬ '..getbioY..' \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉┉ ≈ ┉ ≈ ┉\n')
else
...
if text == '/hlepp' and Mod(msg) then
...
if text == '/hlepp1' and Mod(msg) then
local help_text = database:get(bot_id..'help_text')
Text = [[
اوامر المجموعه 𖤍
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉┉ ≈ ┉ ≈ ┉ 
