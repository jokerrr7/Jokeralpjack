...
local UserName = (data.username_ or "GOLD_TEAM_4")
...
os.execute('wget https://raw.githubusercontent.com/jokerrr7/blaccck/main/GOLD.lua?token=ATRUZD3L5MSSRIKGN64D6TLBTDYR6')
...
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ߷[تحديثات البوت](t.me/GOLD_TEAM_4) \n߷[قناه السورس](t.me/GOLD_TEAM_4)')
end
...
{
{text = '𝗰𝗵𝗮𝗻𝗻𝗲𝗹 ♩', url = "https://t.me/GOLD_TEAM_4"},
},
}
...
usertext = '*\n ߷اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'GOLD_TEAM_4')..')'
status  = '\n *߷تم ترقيته مطور*'
...
usertext = '\n *߷اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'GOLD_TEAM_4')..')'
status  = '\n*߷تم ترقيته مطور*'
...
if GOLD1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *߷اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'GOLD_TEAM_4')..') \n ߷'..GOLD1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
keyboard.inline_keyboard = {
{
{text = '𝗦𝗼𝘂𝗿𝗰𝗲 𝗚𝗼𝗹𝗱', url = "https://t.me/GOLD_TEAM_4"},
},
}
local msg_id = msg.id_/2097152/0.5
...
send(msg.chat_id_,0," *߷العضو :* {["..data.first_name_.."](t.me/GOLD_TEAM_4)}\n߷["..GOLD_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *߷عذرا ↫* {["..data.first_name_.."](t.me/GOLD_TEAM_4)}\n*߷عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
{
{text = '𝙗𝙡𝙖𝙘𝙠 𝙛𝙞𝙡𝙚𝙨 𖢌', url = "https://t.me/GOLD_TEAM_4"}
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/GOLD_TEAM_4&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, '*߷بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'GOLD_TEAM_4')..') \n*߷تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *߷بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'GOLD_TEAM_4')..') \n*߷تـم قفـل التاك بالكتم* ')
end,nil)   
...
local TextE = "\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ \n *߷علامة تعني { ✓ } ملف مفعل*\n *߷علامة تعني { ✘ } ملف معطل*\n *߷قناة سورس بلاك ↓*\n".." *߷*[اضغط هنا لدخول](t.me/GOLD_TEAM_4) \n"
local NumFile = 0
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *߷العضو* » ['..data.first_name_..'](t.me/'..(data.username_ or 'GOLD_TEAM_4')..')'
status  = '\n*߷تم ترقيته ادمن*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *߷لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'GOLD_TEAM_4')..')'
status  = '\n*߷تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *߷اسم المستخدم »* '..userid..''
...
{{text = '𝗰𝗵𝗮𝗻𝗻𝗲𝗹 ♩', url="t.me/GOLD_TEAM_4"}},
}
local msg_id = msg.id_/2097152/0.5
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *߷العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'GOLD_TEAM_4')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *߷اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'GOLD_TEAM_4')..')'..'\n*߷تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
keyboard.inline_keyboard = {
{
{text = texxtt, url="https://t.me/GOLD_TEAM_4"},
},
{
{text = '𝗰𝗵𝗮𝗻𝗻𝗲𝗹 ♩', url = "https://t.me/GOLD_TEAM_4"},
},
...
keyboard.inline_keyboard = {
{
{text = tessttmo, url = "https://t.me/GOLD_TEAM_4"},
},
{
{text = tessttm, url = "https://t.me/GOLD_TEAM_4"},
},
{
{text = '𝗰𝗵𝗮𝗻𝗻𝗲𝗹 ♩', url = "https://t.me/GOLD_TEAM_4"},
}
...
username = 'GOLD_TEAM_4'
end
local msg_id = msg.id_/2097152/0.5  
local textt = '߷ رتبتك '..Rutba(msg.sender_user_id_,msg.chat_id_)
local GOLD_TEAM_4 = 'https://t.me/GOLD_TEAM_4'
keyboard = {} 
keyboard.inline_keyboard = {
{
...
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=' .. URL.escape(GOLD_TEAM_4).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end end 
tdcli_function ({ ID = "GetUserProfilePhotos", user_id_ = msg.sender_user_id_, offset_ = 0, limit_ = 1 }, getpro, nil) 
end,nil)
end
...
local JABWA = 'https://t.me/GOLD_TEAM_4'
keyboard = {} 
keyboard = {} 
keyboard.inline_keyboard = {
{
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'GOLD_TEAM_4')..')'
local iduser = result.sender_user_id_
...
𖢄️╿🄹 ⤍ اوامر الاعضاء .
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉┉ ≈ ┉ ≈ ┉ 
[ 𝗰𝗵𝗮𝗻𝗻𝗲𝗹 ♩](https://t.me/GOLD_TEAM_4) 
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
{{text = '𝘾𝙃 𝙎𝙊𝙐𝙍𝘾𝙀 𐇑', url="t.me/GOLD_TEAM_4"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
if text == '𖢄 𝑠𝑜𝑢𝑟𝑐𝑒 𝑏𝑙𝑎𝑐𝑘 𝑑𝑒𝑣𝑒𝑙𝑜𝑝𝑒𝑟𝑠 ♩ 𖢄' then
local Text = [[
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'توضيح تفعيل المتحر',url="https://t.me/GOLD_TEAM_4/426"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local Text = [[  
[𝐋𝐢𝐧𝐤 𝐓𝐨 𝐃𝐞𝐥𝐞𝐭𝐞 𝐒𝐨𝐜𝐢𝐚𝐥.](t.me/GOLD_TEAM_4)
]]  
keyboard = {}  
keyboard.inline_keyboard = {  
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = 'رجوع',callback_data=data.sender_user_id_.."Bbk"..OnID}},{{text = '𝗰𝗵𝗮𝗻𝗻𝗲𝗹 ♩', url="t.me/GOLD_TEAM_4"}},}
...
{{text = '𝑠𝑜𝑢𝑟𝑐𝑒 𝑏𝑙𝑎𝑐𝑘 𝑑𝑒𝑣𝑒𝑙𝑜𝑝𝑒𝑟𝑠 ♩', url="t.me/GOLD_TEAM_4/1447"}},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐂𝐡𝐚𝐧𝐧𝐞𝐥', url="t.me/GOLD_TEAM_4"},{text = '𝐂𝐡𝐚𝐧𝐧𝐞𝐥 𝟐', url="t.me/GOLD_TEAM_4"}},
{{text = 'رجوع ⤻', callback_data="/help14"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
inline = {
{{text = '𝗰𝗵𝗮𝗻𝗻𝗲𝗹 ♩',url='http://t.me/GOLD_TEAM_4'}},
}
